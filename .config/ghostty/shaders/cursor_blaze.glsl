...
const vec4 TRAIL_COLOR = vec4(0.83, 0.53, 0.61, 0.08); // Gruvbox pink #d3869b - very transparent
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.83, 0.53, 0.61, 0.05); // Gruvbox pink accent - barely visible
const float DURATION = .4;
const float OPACITY = .03;
// Don't draw trail within that distance * cursor size.
// Lowered threshold to show subtle sparks when typing
